    ...
    <div className="p-4 md:p-8 max-w-3xl mx-auto">
      ...
      <Tabs defaultValue="nutrition">
        <TabsList className="grid grid-cols-4 mb-4 rounded-xl">
          <TabsTrigger value="nutrition" className="rounded-lg text-xs sm:text-sm">Питание</TabsTrigger>
          <TabsTrigger value="weight" className="rounded-lg text-xs sm:text-sm">Вес</TabsTrigger>
          <TabsTrigger value="measurements" className="rounded-lg text-xs sm:text-sm">Замеры</TabsTrigger>
          <TabsTrigger value="workouts" className="rounded-lg text-xs sm:text-sm">Тренировки</TabsTrigger>
        </TabsList>
